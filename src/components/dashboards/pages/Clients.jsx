                ...
                >
                  ...
                  <td className="p-3 px-5">
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, n_documento: e.target.value })
                      }
                      className="bg-transparent"
                      disabled
                    />
                  ...
                  <td>
                    <button onClickk={() => navigate("/admin-dashboard/clientes/edit-client")} className="text-sm m-4 bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">
                      Modificar
                    </button>
                    <button
