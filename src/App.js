...
import Pdf from './components/dashboards/pages/tools/Pdf';
      ...
      <div className="bg-gray-200 h-full flex flex-col">
        ...
        <div className="App-body lg:flex  md:flex md:items-center pt-12 w-full h-full">
          <Routes>
            ...
            <Route path='/admin-dashboard/facturacion/generate' element={<ProtectedComponent><Pdf/></ProtectedComponent>}/>
